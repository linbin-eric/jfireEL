...
public class BracketTest extends TestSupport
{
    ...
    public void test60()
    {
        ...
        params.put("name", "ll");
        params.put("age", 10);
        assertEquals("hello ll,my age is 12", Template2.parseUseInnerCall("hello ${name},my age is ${age+2}").render(params));
    }
    ...
    public void test61()
    {
        Map<String, Object> params = new HashMap<String, Object>();
        params.put("name", "ll");
        assertEquals("hello ll", Template2.parseUseInnerCall("hello ${name}").render(params));
    }
    ...
    public void test62()
    {
        ...
        params.put("name", "ll");
        params.put("age", 10);
        assertEquals("hello, my name is ll  ", Template2.parseUseInnerCall("hello,<%if(age>2){%> my name is ${name}<%}%>  ").render(params));
    }
    ...
    public void test63()
    {
        ...
        params.put("name", "ll");
        params.put("age", 10);
        assertEquals("hello, my name is ll", Template2.parseUseInnerCall("hello,<%if(age>2){%> my name is <%if(name=='ll'){%>${name}<%}%><%}%>").render(params));
    }
    ...
    public void test64()
    {
        ...
        params.put("name", "ll");
        params.put("age", 1);
        assertEquals("hello, ll", Template2.parseUseInnerCall("hello,<%if(age>2){%> ${name} <%}%><%else{%> ll<%}%>").render(params));
    }
    ...
    public void test66()
    {
        ...
        params.put("name", "ll");
        params.put("age", 1);
        assertEquals("hello, age<5", Template2.parseUseInnerCall("hello,<%if(age>10){%> ${name} <%} else if(age>5){%> age >5 <%} else {%> age<5<%}%>").render(params));
    }
    ...
    public void test67()
    {
        ...
        Map<String, Object> params = new HashMap<String, Object>();
        params.put("list", list);
        assertEquals("hello, name1 name2", Template2.parseUseInnerCall("hello,<% for (name in list) {%> ${name}<%}%>").render(params));
    }
    ...
    public void test68()
    {
        ...
        Map<String, Object> params = new HashMap<String, Object>();
        params.put("list", list);
        assertEquals("hello, name1", Template2.parseUseInnerCall("hello,<% for (name in list) {%><% if(name=='name1'){%> ${name}<%}%><%}%>").render(params));
    }
    ...
    public void test69()
    {
        ...
        params.put("list", list);
        params.put("age", 11);
        assertEquals(" name1  name2 ", Template2.parseUseInnerCall("<% if(age>10){ for(name in list){ %> ${name} <%}}%>").render(params));
    }
}
